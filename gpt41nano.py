...
This module provides a complete chat agent implementation for OpenAI's GPT-4.1-nano model
...
class OpenAIGPT41NanoChatAgent:
    ...
    def __init__(self, agent_id: str):
        ...
        self.logger.info(f"Initialized OpenAI GPT-4.1 Nano Chat Agent: {agent_id}")
    ...
    def _get_api_key(self) -> str:
        ...
        model_display = self.SUPPORTED_MODEL["gpt-4.1-nano"]["name"]
            ...
            for search_path in search_paths:
                ...
                if file_path.exists() and file_path.is_file():
                    ...
                    try:
                        ...
                        # Add file info header based on file type
    ...
    def _get_timeout_for_model(self) -> int:
        """Get timeout based on the model"""
    ...
    def call_api(self, new_message: str, override_config: Optional[Dict[str, Any]] = None) -> Generator[str, None, None]:
        """Call OpenAI GPT-4.1-nano API with the new message"""
        try:
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="OpenAI GPT-4.1 Nano Chat Agent - Advanced AI Chat Interface",
